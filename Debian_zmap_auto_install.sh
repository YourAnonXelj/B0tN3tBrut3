...
apt-get install gcc cmake gmp gmp-devel libpcap-devel gengetopt byacc flex -y

apt-get install json-c-doc.noarch json-c.i686 json-c.x86_64 json-c-devel.i686 json-c-devel.x86_64 -y

apt-get install epel-release -y

apt-get install gengetopt -y
